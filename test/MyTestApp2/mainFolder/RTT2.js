...
export default class RTT2 extends Component {
  constructor(props) {
    super(props);
  ...
  onPressButton = async () => {
    ...
    function check(ip) {
      return  Ping.start('192.168.43.' + ip);
    }
    // let ips = [];
    // for(let i= 1; i<= 254; i++){
    ...
    //   ips.push({ value: i });
    //   // this.setState({ ips });
    //   // console.log("ip_num: "+this.state.ips+" & i = "+ i);
    // }
